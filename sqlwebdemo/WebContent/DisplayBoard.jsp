...
<body>
	...
	<div id="content">
		<div id="post" style="margin-top: 60px;">
			...
			<H1 ALIGN="CENTER">留言佈告欄</H1>

			<div style="background: #3EADC5; height: 60px;">
				會員名稱：<input type="submit" id="shangtian" name="Submit3"
					style="border: none; background-color: #3EADC5; color: white; width: auto;"
					value="會員用戶點擊改變" onclick="prom()" /> <input type="text"
					id="ritian"
					style="border: none; background-color: #3EADC5; color: white; width: auto;"
					onclick="prom()" />
			</div>
			<FORM ACTION="./ServletComment" method="Post">
				...
				<INPUT id="postBt" type="button"
					...
					value="發表留言" /> <INPUT NAME="clear" TYPE="RESET"
					style="border: none; background-color: #3EADC5; color: white; border-radius: 5px; width: 80px; height: 30px; float: right;"
					VALUE='清除' />
			</FORM>
